...
export function ProfilePreferences() {
  ...
  return (
    <section className="mt-8 space-y-6">
      ...
      <div className="mb-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 px-4 py-3.5 bg-[#f9fafb] border border-[rgba(107,114,128,0.14)] rounded-xl">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <span className="hidden sm:flex items-center gap-1 text-xs text-[#16a34a] transition-opacity">
            <FiCheck size={11} />
            Alerta salvo
          </span>
